...
uauth.url = "https://sircrabapple99.github.io/webretro/uauth/"; // url to use for uauth. must have cross-domain support, a trailing slash, and cannot be cross-origin isolated.
uauth.origins = ["http://localhost:8000", "http://localhost:8001", "https://sircrabapple99.github.io"]; // valid origins for the response
